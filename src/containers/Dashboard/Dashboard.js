			...
			<div>
				<nav className=" dt h-10 w-100 relative bg-black-80 center">
					<div className="dtc v-mid tr pa3">
						<Link className="f6 fw4 hover-white no-underline white-70 dib ml2 pv2 ph3 ba" to="/counter">
							Shelter Capacity
						</Link>
				...
				<div className="tc">
					<a onClick={this.getLatestData} className="f6 grow no-underline br-pill ba bw1 ph3 pv2 mb2 dib black" href="#0">
						Update Data{' '}
					</a>
				</div>
